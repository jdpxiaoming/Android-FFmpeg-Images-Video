...
jstring Java_com_example_xiaoyin_Xiaoyin_stringFromJNI( JNIEnv* env,
                                                  jobject thiz )
{
    ...
    arg[0]="ffmpeg";
    arg[1]="-i";
    arg[2]="/sdcard/video2.avi";
    arg[3]="-i";
    arg[4]="/sdcard/222.mp3";
    arg[5]="-vcodec";
    arg[6]="copy";
    arg[7]="-acodec";
    arg[8] = "copy";
...
jstring Java_com_example_xiaoyin_Xiaoyin_haha( JNIEnv* env,
